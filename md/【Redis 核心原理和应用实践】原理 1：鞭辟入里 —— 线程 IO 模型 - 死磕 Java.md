> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [www.skjava.com](https://www.skjava.com/series/article/1454267286)

>  Redis 是个单线程程序！  这点必须铭记。  也许你会怀疑高并发的 Redis 中间件怎么可能是单线程。很抱歉，它就是单线程，你的怀疑暴露了你基础知识

转

 2023-03-26  阅读 (238)  点赞 (0)
...
![](http://image.skjava.com/article/series/redis/202303261119213501.png)
...
![](http://image.skjava.com/article/series/redis/202303261119224932.png)
...
请阅读老钱的另一篇火爆的文章[《跟着动画来学习 TCP 三次握手和四次挥手》](https://mp.weixin.qq.com/s/j7uxuN2h8mdiLSYmyHIvQQ) 。