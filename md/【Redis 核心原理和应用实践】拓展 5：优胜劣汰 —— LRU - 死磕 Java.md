> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [www.skjava.com](https://www.skjava.com/series/article/6155302014)

> 当 Redis 内存超出物理内存限制时，内存的数据会开始和磁盘产生频繁的交换 (swap)。交换会让 Redis 的性能急剧下降，对于访问量比较频繁的 Redis 来说，这样龟速的存取效率基

转

 2023-03-26  阅读 (216)  点赞 (0)
...
![](http://image.skjava.com/article/series/redis/202303261121508681.png)
...
2、 [《Redis LRU 实现策略》](http://blog.chinaunix.net/uid-20708886-id-5753422.html)
